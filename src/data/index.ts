...
import { Project, Experience, Education, Certification, Achievement, SkillCategory, SocialLink } from '@/types';
...
export const skills: SkillCategory[] = [
  {
    category: "Front-End",
    skills: ["HTML", "CSS", "JavaScript", "TypeScript", "React.js", "Next.js", "Vue.js", "Nuxt.js", "Tailwind CSS"]
  },
  {
    category: "Back-End",
...
export const experience: Experience[] = [
  {
    ...
    technologies: ["Vue.js", "Nuxt.js", "TypeScript", "Tailwind CSS", "JavaScript"]
  },
  {
    id: 2,
    company: "AK Infopark",
    ...
    github: "https://github.com/jeffreyhasan10/PortfolioProjects/tree/main/5-AKinfopark/nike-ecommerce"
  }
];
...
export const projects: Project[] = [
  {
    ...
    description: "Dynamic web app for real-time IPL 2025 insights (match tracking, stats, predictions).",
  ...
  },
  {
    ...
    description: "Premium uniform manufacturer website with responsive, SEO-friendly design.",
  ...
  },
  {
    ...
    description: "Dark-themed SaaS landing page with animations and responsive design.",
    technologies: ["Next.js", "TypeScript", "Tailwind CSS"],
    github: "https://github.com/jeffreyhasan10/eclipse-platform",
    live: "https://eclipse-platform.vercel.app/",
    featured: true
  },
  {
    id: 4,
    title: "Student Attendance Monitoring System Using Deep Learning",
    description: "AI-powered attendance system with facial recognition and geolocation.",
    technologies: ["Python", "OpenCV", "Haar Cascade", "LBPH algorithm", "MySQL"],
    github: "https://github.com/jeffreyhasan10/PortfolioProjects/tree/main/StudentsAttendanceManagement"
  },
  {
    id: 5,
    title: "AI-Powered Nutrition Assistant and Step Tracker (Foody Buddy)",
    description: "Mobile app with AI-driven meal planning and IoT fitness tracking.",
    technologies: ["Python", "Vector Embeddings", "MPU6050", "ESP32", "ThingSpeak IoT"],
    github: "https://github.com/jeffreyhasan10/PortfolioProjects/tree/main/FoodyBuddy-main"
  },
  {
    id: 6,
...
export const achievements: Achievement[] = [
  {
    id: 1,
    title: "IBM-Recognized Machine Learning Project: 'Airline Passenger Satisfaction Identification'",
    description: [
